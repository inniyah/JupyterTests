...
class Mat2:
    ...
    def __mul__(self, other):
        ...
        assert isinstance(other, (int, float, Mat2, Vec2)), 'Requires a int, float, Mat2 or Vec2'
...
class Mat3:
    ...
    def __mul__(self, other):
        ...
        assert isinstance(other, (int, float, Mat3, Vec3)), 'Requires a int, float, Vec3, Mat3'
...
class Mat4:
    ...
    def __mul__(self, other):
        ...
        assert isinstance(other, (int, float, Mat4, Vec4)), 'Requires an int, float, long, Vec4 or Mat4'
